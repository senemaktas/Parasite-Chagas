...
resize_shape = 75   # Input size must be at least 75x75; got `input_shape=(70, 70, 3)
image_folder = '../chagas-capilares/imagenes/gris/'
csv_path = './classification_data/inceptionresnetv2_75_normalized.csv'
npz_path = './classification_data/inceptionresnetv2_75_normalized.npz'
