...
csv_path = './classification_inceptionresnetv2/classification_data/inceptionresnetv2_70_normalized.csv'
npz_path = './classification_inceptionresnetv2/classification_data/inceptionresnetv2_70_normalized.npz'

from pathlib import Path
Path("./classification_inceptionresnetv2/classification_data").mkdir(parents=True, exist_ok=True)
